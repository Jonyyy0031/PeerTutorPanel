        ...
        <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
          ...
          <div className="p-6">
            ...
            <p className="text-center text-gray-900 mb-4">
              ¿Estás seguro que deseas eliminar el registro del{" "}
              <strong>{log.student_name}</strong> del grupo <strong>{log.student_group}</strong>?
            </p>

            <p className="text-center text-gray-500 text-sm mb-6">
              Esta acción no se puede deshacer y eliminará la cita del estudiante.
            </p>
